...
window.onload = function(){
	...
	document.getElementById("manual").onclick = function () {
        location.href = "manual-usuario.html";
	};
...
function moverNave(){
	...
	if (y<70){ 
		...
		stop();
		if (v<5){
			alert("Has GANADO,caido a una velocidad de "+v.toFixed(2)+" km/s")
		} else {
			document.getElementById("nave_off").src = "img/explosion.gif";
...
//Para hacer lo del boton de parar usar variable con false o true 